...
<html>
    ...
    <%for (int i = 60; i < shedWidth+50-10;) {%>
          <rect x="<%=i*2%>" y="<%=50*2%>" height="<%=225*2%>" width="<%=15*2%>"  style="fill: #008000" />  
        <%i+=21;}
    %>
    <!--loop der placere brædderne på ydersiden af skuret -->
    <%for (int i = 75; i < shedWidth+50-10;) {%>
          <rect x="<%=i*2%>" y="<%=50*2%>" height="<%=225*2%>" width="<%=6*2%>"  style="fill: #A52A2A" />  
        <%i+=21;}
    %>
    <!-- stolperne i hver side af skurvæggen -->
    <rect x="<%=(shedWidth+50-10)*2%>" y ="<%=50*2%>" width="<%=10*2%>" height="<%=225*2%>" style="fill: #0000CD"/>
    <rect x="<%=50*2%>" y ="<%=50*2%>" width="<%=10*2%>" height="<%=225*2%>" style="fill: #0000CD"/>
    <!--brædderne der går på tværs -->
    <rect x="<%=50*2%>" y ="<%=50*2+20%>" width="<%=shedWidth*2%>" height="<%=15*2%>" style="fill: #DEC34E"/>
    <rect x="<%=50*2%>" y ="<%=50*2+225-15%>" width="<%=shedWidth*2%>" height="<%=15*2%>" style="fill: #DEC34E"/>
    <rect x="<%=50*2%>" y ="<%=50*2+225*2-15*2%>" width="<%=shedWidth*2%>" height="<%=15*2%>" style="fill: #DEC34E"/>
    <!--linjer på tegningen -->
